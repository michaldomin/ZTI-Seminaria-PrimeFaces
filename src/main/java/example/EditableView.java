...
public class EditableView implements Serializable {
    ...
    public void init() {
        ...
        Element computerA = new Element(new NetworkElement("Computer A", "pc.jpg"), "10em", "6em");
        ...
        Element computerB = new Element(new NetworkElement("Computer B", "pc.jpg"), "25em", "6em");
        ...
        Element computerC = new Element(new NetworkElement("Computer C", "pc.jpg"), "40em", "6em");
        ...
        Element serverA = new Element(new NetworkElement("Server A", "server.png"), "15em", "24em");
        ...
        Element serverB = new Element(new NetworkElement("Server B", "server.png"), "35em", "24em");
